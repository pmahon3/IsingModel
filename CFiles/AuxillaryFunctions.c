...
// genAdjMat generates an adjacency matrix with mean node degree m0, with node degrees distributed according to the probability P(X=x) = x^(-3)
...
int** genAdjMat( int size, int m0 ){

  // Initialize the matrix
  int** adjmat = malloc(sizeof(int*)*size);
  int i,j;
